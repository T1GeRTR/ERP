...
public class GetUserLaborRecord {
    private int id;
    private User user;
    ...
    public GetUserLaborRecord() {
    }

    public GetUserLaborRecord(int hours) {
        setHours(hours);
    }

    public GetUserLaborRecord(int id, User user, LocalDate date, int hours, String taskId, String taskTitle, String projectId, String projectTitle) {
        this.id = id;
        this.user = user;
        this.date = date;
        this.hours = hours;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetUserLaborRecord)) return false;
        GetUserLaborRecord that = (GetUserLaborRecord) o;
